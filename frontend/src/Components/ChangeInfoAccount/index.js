                        ...
                        <div className="row justify-content-md-center">
                          <div  className="col-sm-10">
                            ...
                            <div className="mb-3 row">
                              ...
                              <div className="col-sm-8">
                                <input type="text" readonly className="form-control" style={{backgroundColor: 'white'}} id="staticName" value="Võ Thành Hiếu"/>
                              </div>
                            </div>
                            ...
                            <div className="mb-3 row">
                              ...
                              <div className="col-sm-8">
                                <input type="text" className="form-control" id="staticAccount" value="HieuVo"/>
                              </div>
                            </div>
                            ...
                            <div className="mb-3 row">
                              ...
                              <div className="col-sm-8">
                                <input type="text" className="form-control" id="staticEmail" value="hieu.vo@gmail.com"/>
                              </div>
                            </div>
                            ...
                            <div className="mb-3 row">
                              ...
                              <div className="col-sm-8">
                                <input type="text" className="form-control" id="staticPhone" value="0123451542"/>
                              </div>
                            </div>
                            ...
                            <div className="mb-3 row">
                              ...
                              <div className="col-sm-8">
                                <input type="text" className="form-control" id="staticAddress" value="Tiền Giang"/>
                              </div>
                            </div>

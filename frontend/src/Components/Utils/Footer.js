		...
		<footer class="text-center text-lg-start bg-dark text-light py-4">
			<div class="container">
				<div class ="row d-flex justify-content-between">
					<div class="col-md-6">
						<h5>Công ty TNHH thương mại MyLaptop</h5>
						<p>MyLaptop là doanh nghiệp chuyên cung cấp thiết bị, giải pháp về máy tính, thiết bị chơi game,
							thiết bị công nghệ cao cấp hàng đầu Việt Nam.
						</p>
						<p>Địa chỉ:
							<ul>
								<li>78-80-82 Hoàng Hoa Thám, phường 12, quận Tân Bình, TP.HCM</li>
								<li>17, 24/3, phường An Xuân, tp. Tam Kỳ, Quảng Nam</li>
							</ul>
						</p>
					</div>

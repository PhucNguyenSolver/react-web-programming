...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 29, 2021 lúc 03:40 PM
...
(17, 'bao111', 'user1@gmail.com', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', '0', 'https://i.imgur.com/AxnVk1a.png', NULL),
...
(31, 'anlam0', 'anlam@gmail.com', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', '1', 'https://i.imgur.com/AxnVk1a.png', NULL);
...
(4, 'bảo', '0905', 'ktx khu a'),
(31, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Cấu trúc đóng vai cho view `b`
-- (See below for the actual view)
--
CREATE TABLE `b` (
`accId` int(10) unsigned
...
(10, 17, 10, 1, '2021-07-30 00:00:00', 'Còn màu khác không');
...
(2, 7, 1, '2021-07-07 00:00:00', NULL, 7000000),
(3, 7, 1, '2021-10-05 00:00:00', NULL, 2000000),
(4, 25, 1, '2021-08-11 00:00:00', NULL, 3000000),
(7, 26, 1, '2021-09-26 00:00:00', NULL, 2000000),
(8, 27, 1, '2021-11-24 00:00:00', NULL, 22790000);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `acc`  AS SELECT `a`.`accId` AS `accId`, `a`.`userName` AS `userName`, `a`.`email` AS `email`, `a`.`password` AS `password`, `a`.`isAdmin` AS `isAdmin`, `a`.`avatar` AS `avatar`, `a`.`code` AS `code`, `a`.`admId` AS `admId`, `a`.`name` AS `name`, `a`.`phoneNumber` AS `phoneNumber`, `a`.`address` AS `address` FROM `a` ;
...
--
ALTER TABLE `account`
  MODIFY `accId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT cho bảng `comment`
--
ALTER TABLE `comment`
  MODIFY `cmtId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `product`
  MODIFY `productId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
